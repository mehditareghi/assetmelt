...
const tabsListVariants = cva(
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-full p-1 text-muted-foreground group-data-[orientation=horizontal]/tabs:h-9 group-data-[orientation=vertical]/tabs:h-fit group-data-[orientation=vertical]/tabs:flex-col data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        default:
          "glass-surface w-full border-primary/10 bg-background/30 text-muted-foreground dark:border-primary/15 dark:bg-background/20",
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[state=active]:border-primary/20 data-[state=active]:bg-background/80 data-[state=active]:text-foreground data-[state=active]:shadow-sm",
        "dark:data-[state=active]:border-primary/40 dark:data-[state=active]:bg-primary/15 dark:data-[state=active]:text-primary dark:data-[state=active]:shadow-[0_0_14px_-4px] dark:data-[state=active]:shadow-primary/35",
