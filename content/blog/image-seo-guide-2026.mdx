...
| Step | Topic | Section |
| --- | --- | --- |
| 1 | Filenames for crawlers | [Name files](#step-1-name-files-for-humans-and-crawlers) |
| 2 | Inclusive alt text | [Write alt text](#step-2-write-alt-text-everyone-can-use) |
| 3 | Modern formats | [Choose formats](#step-3-choose-formats-that-search-engines-and-browsers-agree-on) |
| 4 | Responsive delivery | [Ship srcset](#step-4-ship-responsive-images-not-one-size-fits-all) |
| 5 | Privacy hygiene | [Strip EXIF](#step-5-strip-exif-and-publish-clean-bytes) |
| 6 | Structured data | [Sitemaps & JSON-LD](#step-6-structured-data-and-image-sitemaps) |
| 7 | CMS workflows | [WordPress, Shopify, static](#step-7-platform-specific-workflows) |
| — | Deep dives | [Guides in this topic](#guides-in-this-topic) |
| — | By site type | [Ecommerce, blog, SaaS](#image-seo-by-site-type) |
| — | Google Images | [Visual search traffic](#optimizing-for-google-images) |
...
For LCP-specific tuning — hero priority, fetchpriority, lazy-loading rules — read our [Core Web Vitals image guide](/blog/performance-seo/optimize-images-core-web-vitals-lcp). This article focuses on discoverability, accessibility, and the prep work that feeds both.
</Callout>
...
Use our [image SEO checklist](/blog/performance-seo/image-seo-checklist) as a printable audit once you understand the pipeline below — it distills these three pillars into a pre-publish gate you can run on every template.
...
- **Image sitemaps** when you have thousands of SKUs — see [image sitemap guide](/blog/performance-seo/image-sitemap-guide)
- **Pre-upload compression** — [Shopify workflow](/blog/image-compression/compress-images-for-shopify)
...
- **Featured image + OG export** at 1200×630 — [social size guide](/blog/performance-seo/best-image-sizes-open-graph-social-media)
- **Inline figures** with accurate alt, not keyword-stuffed captions
- **Responsive srcset** so mobile readers do not download desktop heroes — [responsive images guide](/blog/performance-seo/responsive-images-guide)
...
Open the <ToolLink tool="avif-compressor">AVIF compressor</ToolLink> for hero images, or the <ToolLink tool="batch-image-compressor">batch compressor</ToolLink> when a catalog refresh ships dozens of files. For a deeper format comparison, see [AVIF vs WebP in 2026](/blog/format-conversion/avif-vs-webp-2026).
...
For art direction — different crops at different breakpoints — see the dedicated [responsive images guide](/blog/performance-seo/responsive-images-guide). The planner above covers the common single-aspect-ratio case.
...
- Smallest viable file after format + resize — [how images affect LCP](/blog/performance-seo/how-images-affect-lcp)

If PageSpeed flags "Properly size images" or "LCP image lazy loaded", start with [fix large image LCP issues](/blog/performance-seo/fix-large-image-lcp).
...
In Asset Melt, enable **Strip metadata** in the studio settings (on by default in the Web Optimized preset). Re-encoding to AVIF or WebP produces a fresh file with pixels only — the same privacy property that makes [browser compression](/blog/image-compression/compress-images-in-browser) trustworthy for NDA client work.
...
Skip this if you run a text-first blog with one decorative header per post — standard URL sitemaps are enough. When you do need them, the [image sitemap guide](/blog/performance-seo/image-sitemap-guide) walks through XML structure, CMS plugins, and static generation.
...
4. **Pre-publish checklist** — use the [image SEO checklist](/blog/performance-seo/image-seo-checklist) for every new template or landing page
...
Asset Melt exists at that intersection — the same WASM codecs Google shipped in Squoosh, with batch export, metadata stripping, and offline support. See the [Squoosh alternative guide](/blog/image-compression/squoosh-alternative-guide) if you are migrating from Google's deprecated tool.
...
| Guide | Best for |
| --- | --- |
| [Image SEO checklist](/blog/performance-seo/image-seo-checklist) | Printable pre-publish audit you can run on every page |
| [How images affect LCP](/blog/performance-seo/how-images-affect-lcp) | Why image weight dominates Largest Contentful Paint |
| [Fix large image LCP issues](/blog/performance-seo/fix-large-image-lcp) | Debugging and fixing slow hero delivery |
| [Optimize images for Core Web Vitals](/blog/performance-seo/optimize-images-core-web-vitals-lcp) | LCP, CLS, and INP tuning beyond alt text |
| [Image lazy loading best practices](/blog/performance-seo/image-lazy-loading-best-practices-2026) | Native loading="lazy", Intersection Observer, and LCP tradeoffs |
| [Responsive images guide](/blog/performance-seo/responsive-images-guide) | `srcset`, `sizes`, and art direction in depth |
| [Image sitemap guide](/blog/performance-seo/image-sitemap-guide) | When and how to add image entries to your sitemap |
| [Best image sizes for Open Graph and social](/blog/performance-seo/best-image-sizes-open-graph-social-media) | OG dimensions, crops, and preview file budgets |
...
**Related reading:** [Optimize images for Core Web Vitals](/blog/performance-seo/optimize-images-core-web-vitals-lcp) · [Compress images in the browser](/blog/image-compression/compress-images-in-browser) · [HEIC to JPG without uploading](/blog/format-conversion/heic-to-jpg-browser-guide) · [AVIF vs WebP](/blog/format-conversion/avif-vs-webp-2026)
